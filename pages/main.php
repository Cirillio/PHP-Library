                ...
                <div class="flex flex-col items-center gap-10  flex-3/4">
                    ...
                    <div class="w-full grid h-fit xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-1 sm:gap-x-2 sm:gap-y-4">
                        <?php foreach ($books as $book): ?>
                            <div data-in-cart="false" data-id="<?= $book->id ?>" data-price="<?= $book->price ?>" data-stock="<?= $book->stock ?>" class="book flex flex-col bg-base-200 duration-300 hover:border-base-content border transition-all duration-75 border-base-100 rounded-lg overflow-hidden gap-2">
